 ...
 */
final class Version20220205071155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE link (id INT NOT NULL, name VARCHAR(255) NOT NULL, url TEXT NOT NULL, transitions INT DEFAULT NULL, lifetime TIME(0) WITHOUT TIME ZONE NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
